...
hl.bind("SUPER + SHIFT + N", hl.dsp.global("quickshell:sidebarLeftToggle"))
...
hl.bind("CTRL + SUPER + K", hl.dsp.layout("splitratio -0.1"), { repeating = true })
hl.bind("CTRL + SUPER + J", hl.dsp.layout("splitratio +0.1"), { repeating = true })
hl.bind("CTRL + SUPER + H", hl.dsp.window.resize({ x = -10, y = 0, relative = true }), { repeating = true })

hl.bind("CTRL + SUPER + L", hl.dsp.window.resize({ x = 10, y = 0, relative = true }), { repeating = true })
