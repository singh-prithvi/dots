-- lua/config/keymaps/misc.lua
-- Miscellaneous keymaps that don't fit a specific domain.
...
-- In visual mode, paste replaces selection but keeps original yank in register
